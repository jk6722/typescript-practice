class Person { // 클래스의 이름은 보통 대문자로 시작하는 것이 원칙이다.
...
class ClassName {
  private static instsance: ClassName | null = null;
  ...
  private constructor() {} // constructor를 private로 선언하여 밖에서 new를 통해 객체를 생성할 수 없게 함
}

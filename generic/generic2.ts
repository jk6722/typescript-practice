...
function helloBasic_<T, U>(message: T, comment: U): T {
  return message;
}

console.log(helloBasic<string>('Hello world')); // 이렇게 호출할 때 <> 안에 원하는 type을 지정해줄 수 있다.
...
helloBasic_<string, number>('Mark', 39);
helloBasic_(36, 39);